function [fig,paths] = create_3D_lunar_base_branch_less()
    close all
    ...
    paths('PA01_1') = struct('connections', {{'J44'; 'J41'; 'MA12'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1]);          % Angles in radians

    paths('PA01_2') = struct('connections', {{'J43'; 'J44'; 'MA11'}}, ...
    ...
    paths('MA02') = struct('connections', {{'J12'; 'J13'; 'J21'; 'J22'}}, ...
    ...
    paths('MA14') = struct('connections', {{'J14'; 'J13'; 'J21'; 'J24'}}, ...
    ...
    paths('MA03') = struct('connections', {{'J22'; 'J23'; 'J31'; 'J32'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('MA13') = struct('connections', {{ 'J24'; 'J23'; 'J31'; 'J34'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('MA04') = struct('connections', {{'J32'; 'J33'; 'J41'; 'J42'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('MA12') = struct('connections', {{'J34'; 'J33'; 'J41'; 'J44'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('MA05') = struct('connections', {{'J42'; 'J43'; 'J51'; 'J52'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('MA11') = struct('connections', {{'J44'; 'J43';'J51'; 'J54'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('MA06') = struct('connections', {{'J52'; 'J53'; 'J61'; 'J62'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('MA10') = struct('connections', {{'J54'; 'J53'; 'J61'; 'J64'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('MA07') = struct('connections', {{'J62'; 'J63'; 'J71'; 'J72'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('MA09') = struct('connections', {{'J64'; 'J63'; 'J71'; 'J74'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J11') = struct('connections', {{'MA01'; 'J12'; 'J14'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J12') = struct('connections', {{'J11'; 'J13'; 'MA01'; 'MA02'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('J13') = struct('connections', {{'MA02'; 'MA14'; 'J12'; 'J14'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J14') = struct('connections', {{'J11'; 'J13'; 'MA01'; 'MA14'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J21') = struct('connections', {{'MA02'; 'MA14'; 'J22'; 'J24'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J22') = struct('connections', {{'J21'; 'J23'; 'MA02'; 'MA03'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('J23') = struct('connections', {{'MA03'; 'MA13'; 'J22'; 'J24'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J24') = struct('connections', {{'J21'; 'J23'; 'MA14'; 'MA13'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J31') = struct('connections', {{'MA03'; 'MA13'; 'J32'; 'J34'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J32') = struct('connections', {{'J31'; 'J33'; 'MA03'; 'MA04'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('J33') = struct('connections', {{'MA04'; 'MA12'; 'J32'; 'J34'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J34') = struct('connections', {{'J31'; 'J33'; 'MA13'; 'MA12'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J41') = struct('connections', {{'MA04'; 'MA12'; 'J42'; 'J44'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J43') = struct('connections', {{'MA05'; 'MA11'; 'J42'; 'J44'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J44') = struct('connections', {{'J41'; 'J43'; 'MA12'; 'MA11'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J51') = struct('connections', {{'MA05'; 'MA11'; 'J52'; 'J54'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J52') = struct('connections', {{ 'J51'; 'J53'; 'MA05'; 'MA06'}}, ...
        'coordinates', coords.top, ...    % Path points
        'tangents', tangents.top, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.top(1,:), ...    % First point of path
    ...
    paths('J53') = struct('connections', {{'MA06'; 'MA10'; 'J52'; 'J54'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J54') = struct('connections', {{'J51'; 'J53'; 'MA11'; 'MA10'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J61') = struct('connections', {{'MA06'; 'MA10'; 'J62'; 'J64'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J63') = struct('connections', {{'MA07'; 'MA09'; 'J62'; 'J64'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J64') = struct('connections', {{'J61'; 'J63'; 'MA10'; 'MA09'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('J71') = struct('connections', {{'MA07'; 'MA09'; 'J72'; 'J74'}}, ...
        'coordinates', coords.left, ...    % Path points
        'tangents', tangents.left, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.left(1,:), ...    % First point of path
    ...
    paths('J73') = struct('connections', {{'MA08'; 'J72'; 'J74'}}, ...
        'coordinates', coords.right, ...    % Path points
        'tangents', tangents.right, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.right(1,:), ...    % First point of path
    ...
    paths('J74') = struct('connections', {{ 'J71'; 'J73'; 'MA08'; 'MA09'}}, ...
        'coordinates', coords.bottom, ...    % Path points
        'tangents', tangents.bottom, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords.bottom(1,:), ...    % First point of path
    ...
    paths('MA01') = struct('connections', {{'J12'; 'J14'; 'J11'}}, ...
    ...
    paths('MA08') = struct('connections', {{'J72'; 'J74'; 'J73'}}, ...
        'coordinates', coords, ...    % Path points
        'tangents', tangents, ...       % Unit vectors for orientation
        'headings', [n,1],...          % Angles in radians
        'start_point', coords(1,:), ...    % First point of path
